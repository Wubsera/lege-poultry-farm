...
<head>
    ...
    <title>Edit User - {{ $farm->farm_name ?? 'Farm' }}</title>
...
<div class="header">
    ...
    <p>
        Update user information for {{ $farm->farm_name ?? 'your farm' }}
    </p>
    ...
    <div class="card">
        ...
        >
            ...
            <div class="field">
                ...
                <div class="help">
                    Leave blank if you do not want to change the PIN.
                </div>
